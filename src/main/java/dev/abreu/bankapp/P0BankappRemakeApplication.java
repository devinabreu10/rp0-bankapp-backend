...
public class P0BankappRemakeApplication {
	...
	// 5. Push this project to GitHub, make sure the right files are being ignored to avoid disaster again
	//    --- .gitignore is opened in notepad++
	// 6. Check if mvnw and mvnw.cmd are needed before pushin to GitHub
